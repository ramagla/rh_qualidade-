...
from metrologia.models import CalibracaoDispositivo, TabelaTecnica, Afericao
...
class CalibracaoDispositivoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'data_afericao': forms.DateInput(attrs={'type': 'date', 'class': 'form-control'}, format='%Y-%m-%d'),
