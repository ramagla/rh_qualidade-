...
class TabelaTecnica(models.Model):
    ...
    capacidade_minima = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="Capacidade de Medição Mínima")
    capacidade_maxima = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="Capacidade de Medição Máxima")
    ...
    exatidao_requerida = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="Exatidão Requerida", null=True, blank=True)
    ...
    faixa = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="Faixa (%)")  # Novo campo
