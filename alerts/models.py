...
class Alerta(models.Model):
    ...
    nome = models.CharField(max_length=100, unique=True, choices=ALERTA_CHOICES, verbose_name="Nome do Alerta")
    descricao = models.TextField(verbose_name="Descrição do Alerta")
    ativo = models.BooleanField(default=True, verbose_name="Ativo")
    destinatarios = models.TextField(verbose_name="Destinatários (e-mails separados por vírgula)")  # Campo para os e-mails
