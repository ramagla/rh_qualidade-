...
from qualidade_fornecimento.forms.inspecao_servico_externo_form import InspecaoServicoExternoForm
from qualidade_fornecimento.services.pdf_inspecao_servico_externo import gerar_pdf_inspecao_servico_externo  # 🆕 Importa o gerador de PDF
...
def selecionar_servico_para_inspecao(request):
    ...
    return render(request, "inspecao_servico_externo/selecionar_servico.html", {
        "servicos": servicos
    })
...
from qualidade_fornecimento.models.controle_servico_externo import ControleServicoExterno
from qualidade_fornecimento.forms.inspecao_servico_externo_form import InspecaoServicoExternoForm
from qualidade_fornecimento.tasks import gerar_pdf_inspecao_servico_background  # 🆕 Importa a task
...
def cadastrar_inspecao_servico_externo(request, servico_id):
    ...
    return render(request, "inspecao_servico_externo/inspecao_servico_externo_form.html", {
        "form": form,
        "servico": servico,
        "modo": "Cadastro",
    })
