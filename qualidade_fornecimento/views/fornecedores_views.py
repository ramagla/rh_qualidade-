...
def lista_fornecedores(request):
    ...
    filter_produtos = sorted(set(fornecedores_qs.values_list('produto_servico', flat=True)))
    filter_certificacoes = sorted(set(fornecedores_qs.values_list('tipo_certificacao', flat=True)))
    ...
    total_vencidas = fornecedores_qs.filter(vencimento_certificacao__lt=timezone.now().date()).count()
