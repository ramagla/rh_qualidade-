...
class MateriaPrimaCatalogo(models.Model):
    ...
    blank=True,
    null=True,
    verbose_name="Tolerância"
    )
    tolerancia_largura = models.CharField(max_length=50, blank=True, null=True, verbose_name="Tolerância Largura")
