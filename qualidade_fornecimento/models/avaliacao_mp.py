...
from .fornecedor import FornecedorQualificado  # ajuste conforme sua estrutura de projeto

class AvaliacaoFornecedorMP(models.Model):
    ...
    def __str__(self):
        return f"{self.fornecedor.razao_social} - {self.mes_referencia}/{self.ano_referencia}"
