...
class RelacaoMateriaPrimaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'data_prevista_entrega': DateInput(attrs={'type': 'date', 'class': 'form-control'}),
            'data_renegociada_entrega': DateInput(attrs={'type': 'date', 'class': 'form-control'}),
            ...
            'anexo_certificado': forms.ClearableFileInput(attrs={'class': 'form-control'}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["materia_prima"].queryset = MateriaPrimaCatalogo.objects.all().order_by("codigo")
        self.fields["materia_prima"].label_from_instance = lambda obj: f"{obj.codigo} - {obj.descricao}"

        self.fields["fornecedor"].queryset = FornecedorQualificado.objects.all().order_by("nome")
        self.fields["fornecedor"].label_from_instance = lambda obj: f"{obj.nome} - {obj.produto_servico}"
