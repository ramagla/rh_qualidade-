...
from qualidade_fornecimento.models.controle_servico_externo import ControleServicoExterno, RetornoDiario
...
class ControleServicoExternoForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['codigo_bm'].queryset = MateriaPrimaCatalogo.objects.filter(tipo="Tratamento").order_by('codigo')
...
class RetornoDiarioForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['data'].widget = forms.DateInput(attrs={
            'type': 'date',
            'class': 'form-control'
        })
