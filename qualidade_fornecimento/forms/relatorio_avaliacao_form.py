...
class RelatorioAvaliacaoForm(forms.Form):
    ano = forms.IntegerField(label="Ano", initial=2024, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    semestre = forms.ChoiceField(choices=SEMESTRES, widget=forms.Select(attrs={'class': 'form-select'}))
