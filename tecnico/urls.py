...
from tecnico.views import indicadores_views, maquina_views, roteiros_views
...
urlpatterns = [
    ...
    path("maquinas/importar/", maquina_views.importar_maquinas_view, name="tecnico_importar_maquinas_excel"),
    ...
    # Indicadores
    path(
        "indicadores/5.1-prazo-desenvolvimento/",
