# tecnico/utils/indicadores.py

from tecnico.models.indicador import IndicadorTecnicoRegistroMensal
...
def salvar_registro_indicador(indicador, ano, mes=None, trimestre=None, valor=0.0, media=0.0, meta=0.0,
    ...
    obj, created = IndicadorTecnicoRegistroMensal.objects.get_or_create(
        indicador=indicador,
        ano=ano,
        mes=mes,
        trimestre=trimestre,
