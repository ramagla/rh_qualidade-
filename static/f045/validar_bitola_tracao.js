// validar_bitola_tracao.js — “motor” dos rolos. Certificado reaproveita os MESMOS limites e unidade.
function validarBitolaETracao(roloId) {
  ...
  const largura   = largInput ? parseFloat((largInput.value || "").replace(",", ".")) : null; // ✅ corrigido
