...
def global_menu(request):
    ...
    metrologia_permitido = user.has_perm(
        "metrologia.view_calibracaodispositivo"
    ) or user.has_perm("metrologia.view_tabelatecnica")
    recursos_humanos_permitido = user.has_perm(
        "Funcionario.view_funcionario"
    ) or user.has_perm("Funcionario.view_treinamento")
    ...
    if user.has_perm("metrologia.view_calibracaodispositivo") or user.has_perm(
        "metrologia.view_calibracao"
    ):
        menu_metrologia.append(
            {
                "name": "Calibrações",
    ...
    if recursos_humanos_permitido:
        ...
        if user.has_perm("Funcionario.view_avaliacaoanual") or user.has_perm(
            "Funcionario.view_avaliacaoexperiencia"
        ):
            menu_recursos_humanos.append(
                {
                    "name": "Desempenho",
        ...
        if user.has_perm("Funcionario.view_treinamento") or user.has_perm(
            "Funcionario.view_avaliacaotreinamento"
        ):
            menu_recursos_humanos.append(
                {
                    "name": "Relatórios",
    ...
    if metrologia_permitido:
        modulos_disponiveis.append(
            {"name": "Metrologia", "url": "metrologia_home", "icon": "bi bi-rulers"}
        )
    if recursos_humanos_permitido:
        modulos_disponiveis.append(
            {"name": "Recursos Humanos", "url": "home", "icon": "bi bi-people"}
        )
